  ...
  <div class="container">
       ...
       <div class="row">
            <div class="box" style="">
                ...
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="images/dy_patil.jpg" alt="">
                </div>
                <div class="col-md-6">
                  <hr>
					<table class="table col-lg-7 col-md-7 col-sm-8 col-xs-7">
							...
							<tr>
								...
								<?php
								$venue_name='';
								$query=mysqli_query($conn,"select venue_name from venue where venue_id='".$_GET['venue']."'");
							...
							<tr>
								...
								<?php
								$city='';
								$query=mysqli_query($conn,"select city from venue where venue_id='".$_GET['venue']."'");
								while($row = mysqli_fetch_array($query))
								{
							    //		$venue_name.=$row[0];
								//	$team_name.=$row[1];
								...
								<?php
								$capacity='';
								$query=mysqli_query($conn,"select capacity from venue where venue_id='".$_GET['venue']."'");
								while($row = mysqli_fetch_array($query))
								{
								//	$venue_name.=$row[0];
								//	$team_name.=$row[1];

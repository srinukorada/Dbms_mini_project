	...
	?>                                            
       ...
       <div class="row">
            <div class="box" style="">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><?php if($row10){echo $row10[0];}?></strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="images/9.jpg" alt="">
                </div>
                <div class="col-md-6">
			...
			<h2 class="sub-header"><span><a href="team8.php">Squad List</a></span> </h2>

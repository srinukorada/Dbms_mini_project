...
<?php
  ...
  // echo "page opened";
   	...
   	//$scoreruser='conor.hammes';
  // echo "values added\n$name\n $city $capacity\n";
   	if (count($errors) == 0) {
	//	echo "\nerrorrs count is zero";
   	$query="INSERT INTO admin (adm_id,passwd,role) VALUES ('$name','$passwd','scorer')";
  // 	echo "\nhi";
	...
	echo "<script type='text/javascript'>location.href = 'admin_home.php';</script>";
   	...
   	echo "<script type='text/javascript'>location.href = 'add_scorer.php';</script>";
